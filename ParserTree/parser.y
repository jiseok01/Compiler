...
FuncDecl:
    ...
    {$$ = makeNode("FUNC", NULL, $2);
     ...
     $2->bro->bro = $8;
     $2->bro->bro->bro = $10;
     if ($2->bro->bro->bro == NULL)
           {$2->bro->bro->bro=$11; }
     else {$2->bro->bro->bro->bro=$11;}}
    ;
